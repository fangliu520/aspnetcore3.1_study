/*************************************************************************************
   ...
   * 类 名 称：       DBMappingExtend
   * 机器名称：       WIN-AQ2FSGMEQLL
   * 命名空间：       AppNetCore.Service.Extend
   * 文 件 名：       DBMappingExtend
   * 创建时间：       2020/9/29 16:46:15
   * 作    者：       LIUFANG
   * 说   明：
   * 类型                    命外规则                     说明
...
namespace AppNetCore.Service.Extend
{
    public static class DBMappingExtend
    {
        ...
        {
            if (t.IsDefined(typeof(BaseMappinigAttribute), true))
            {
                var attribute = t.GetCustomAttribute<BaseMappinigAttribute>();
