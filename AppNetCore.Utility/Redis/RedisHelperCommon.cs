/*************************************************************************************
   ...
   * 类 名 称：       RedisHelperCommon
   * 机器名称：       WIN-AQ2FSGMEQLL
   * 命名空间：       AppNetCore.Utility.Redis
   * 文 件 名：       RedisHelperCommon
   * 创建时间：       2020/11/12 10:29:15
   * 作    者：       LIUFANG
   * 说   明：
   * 类型                    命外规则                     说明
...
{
    public class RedisHelperCommon
    {
        /// <summary>
        /// 连接字符串
        /// </summary>
        ...
        public RedisHelperCommon(int db = -1)
        {
        ...
        #region Redis:  SortedSet 操作
        #region Redis: SortedSet 非Async
        /// <summary>
        /// sortedset 新增
        /// </summary>
        /// <param name="redisKey"></param>
