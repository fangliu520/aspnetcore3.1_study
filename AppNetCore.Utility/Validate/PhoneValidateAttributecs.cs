/*************************************************************************************
   ...
   * 类 名 称：       PhoneValidateAttributecs
   * 机器名称：       WIN-AQ2FSGMEQLL
   * 命名空间：       AppNetCore.Service.Validate
   * 文 件 名：       PhoneValidateAttributecs
   * 创建时间：       2020/9/30 9:28:35
   * 作    者：       LIUFANG
   * 说   明：
   * 类型                    命外规则                     说明
...
{
    public class PhoneValidateAttributecs : BaseValidateAttribute
    {
        private string error;
        public override string ErrorMsg
        {
            get { return error ?? "手机号格式错误"; }
            set { error = value; }
        }
