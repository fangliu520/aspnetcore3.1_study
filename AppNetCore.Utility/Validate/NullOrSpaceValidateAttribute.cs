/*************************************************************************************
   ...
   * 类 名 称：       NullOrSpaceValidateAttribute
   * 机器名称：       WIN-AQ2FSGMEQLL
   * 命名空间：       AppNetCore.Service.Validate
   * 文 件 名：       NullOrSpaceValidateAttribute
   * 创建时间：       2020/9/30 9:26:28
   * 作    者：       LIUFANG
   * 说   明：
   * 类型                    命外规则                     说明
...
{
    public class NullOrSpaceValidateAttribute : BaseValidateAttribute
    {

        private string error;
        public override string ErrorMsg
        {
            get { return error?? "字段不能为空"; }
            set { error = value; }
        }
