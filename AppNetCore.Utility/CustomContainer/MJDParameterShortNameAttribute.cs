/*************************************************************************************
   ...
   * 类 名 称：       MJDParameterAttribute
   * 机器名称：       WIN-AQ2FSGMEQLL
   * 命名空间：       AppNetCore.Utility.CustomContainer
   * 文 件 名：       MJDParameterAttribute
   * 创建时间：       2020/11/17 17:59:14
   * 作    者：       LIUFANG
   * 说   明：
   * 类型                    命外规则                     说明
...
namespace AppNetCore.Utility.CustomContainer
{
    ...
    public class MJDParameterShortNameAttribute : Attribute
    {
        public string ShortName { get; private set; }
        public MJDParameterShortNameAttribute(string shortName)
        {
            ShortName = shortName;
        }
    }
